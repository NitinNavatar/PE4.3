...
/*	@FindBy(xpath="(//div[@class='step_3']//a[@title='Send'])[2]")
	...
	@FindBy(xpath="//a[@id='submitButtonId']")
	private WebElement selectAReportPopUpCrossIcon;
...
@FindBy(xpath="//a[@title='Revert to Defaults'][@style='display: inline-block;']")
private WebElement columnToDisplayRevertToDefaultBtn;
