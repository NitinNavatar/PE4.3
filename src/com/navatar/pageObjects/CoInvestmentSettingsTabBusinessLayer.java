...
public class CoInvestmentSettingsTabBusinessLayer extends NavatarSetupPageBusinessLayer{
	...
	public boolean activateCoInvestmentSetting(String environment, String mode,String fundName) {
		...
		if(click(driver,getEditButtonforNavatarSetUpSideMenuTab(environment, mode, NavatarSetupSideMenuTab.CoInvestmentSettings, 30),"edit button", action.SCROLLANDBOOLEAN)) {
			ThreadSleep(2000);
			if(click(driver, getEnableCheckBoxforClickNavatarSetUpSideMenuTab(environment, mode, NavatarSetupSideMenuTab.CoInvestmentSettings, EditViewMode.Edit, 30), "Automatically link any Co-investment Fundraisings or Commitments to this Fund check box", action.SCROLLANDBOOLEAN)) {
