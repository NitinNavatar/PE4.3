...
public class DealCreationTabBusinessLayer extends DealCreationTab {
	...
	public SoftAssert verifyingInstitutionRequiredFieldListDealInformationLayout(String environment,String mode,String dropdDownLayout,String[][] rowValues){
		...
		String defaultValue="Company_VC";
...
//			}
	...
	public SoftAssert verifyingInstitutionRequiredFieldListNewSourceFirmLayout(String environment,String mode,String dropdDownLayout,String[][] rowValues){
		...
		if(defaultSelectedValue!=null && defaultValue.equals(defaultSelectedValue)){
			...
			appLog.error("Default Selected Value Not verified for Institution Layout Expected : "+defaultValue+"\t Actual : "+defaultSelectedValue);
			saa.assertTrue(false, "Default Selected Value Not verified for Institution Layout Expected : "+defaultValue+"\t Actual : "+defaultSelectedValue);	
		}
	...
	public SoftAssert verifyingContactRequiredFieldListNewSourceContactLayout(String environment,String mode,String dropdDownLayout,String[][] rowValues){
		SoftAssert saa = new SoftAssert();
		String defaultValue="Contacts_VC";
		...
		if(defaultSelectedValue!=null && defaultValue.equals(defaultSelectedValue)){
			...
			appLog.error("Default Selected Value Not verified for Contact Layout Expected : "+defaultValue+"\t Actual : "+defaultSelectedValue);
			saa.assertTrue(false, "Default Selected Value Not verified for Contact Layout Expected : "+defaultValue+"\t Actual : "+defaultSelectedValue);	
		}
